...
$('#contentHolder').append('<div id="searchBar" class="demo-charts mdl-color--white mdl-shadow--2dp mdl-cell mdl-cell--12-col mdl-grid" style="width:100% !important;height: 52px;background-color: #DE5F4D !important;margin-left:0px;margin-top:0px;">' +
  ...
  '<option value="Numbers">Numbers</option>'+
		...
		'<option value="1st Samuel">1st Samuel</option>'+
		'<option value="2nd Samuel">2nd Samuel</option>'+
		'<option value="1st Kings">1st Kings</option>'+
		'<option value="2nd Kings">2nd Kings</option>'+
		...
		'<option value="1st Corinthians">1st Corinthians</option>'+
		'<option value="2nd Corinthians">2nd Corinthians</option>'+
		...
		'<option value="1st Timothy">1st Timothy</option>'+
		'<option value="2nd Timothy">2nd Timothy</option>'+
		...
		'<option value="1st John">1st John</option>'+
		'<option value="2nd John">2nd John</option>'+
		'<option value="3rd John">3rd John</option>'+
