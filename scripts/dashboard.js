...
function loadIndividualSpeaker(speakerID) {
  ...
  $('#searchBar').remove();
    ...
    url = 'https://www.thebodyofchrist.us/' + speakerID;
...
//            }
            ...
            window.teachingAudio = document.getElementById("teachingAudio");
            window.teachingAudio.addEventListener("play", function() {
                window.polling = setTimeout(updateAudioStatus, 5000);
            });


            window.teachingAudio.addEventListener("pause", function() {
            ...
            window.teachingAudio.onended = function() {
...
//sermonRatingHistoryLoadData();
  ...
  $('body').append('<div id="audioHolder" class="mdl-snackbar mdl-snackbar--active"  style="z-index:9000 !important; display:none;padding-left: 20px;padding-right: 20px; margin-top:30px !important; margin-left: -144px;"></div>');
...
$('#contentHolder').append('<div id="searchBar" class="demo-charts mdl-color--white mdl-shadow--2dp mdl-cell mdl-cell--12-col mdl-grid" style="width:100% !important;height: 52px;background-color: #DE5F4D !important;margin-left:0px;margin-top:0px;">' +
  ...
  '<option value="Numbers">Numbers</option>'+
		...
		'<option value="1Samuel">1st Samuel</option>'+
		'<option value="2Samuel">2nd Samuel</option>'+
		'<option value="1Kings">1st Kings</option>'+
		'<option value="2Kings">2nd Kings</option>'+
		...
		'<option value="1Corinthians">1st Corinthians</option>'+
		'<option value="2Corinthians">2nd Corinthians</option>'+
		'<option value="Galations">Galations</option>'+
		'<option value="Ephesians">Ephesians</option>'+
		'<option value="Philippians">Philippians</option>'+
		'<option value="Colossians">Colossians</option>'+
		'<option value="1st Thessalonians">1st Thessalonians</option>'+
		'<option value="2nd Thessalonians">2nd Thessalonians</option>'+
		'<option value="1Timothy">1st Timothy</option>'+
		'<option value="2Timothy">2nd Timothy</option>'+
		'<option value="Titus">Titus</option>'+
		'<option value="Philemon">Philemon</option>'+
		'<option value="Hebrews">Hebrews</option>'+
		'<option value="James">James</option>'+
		'<option value="1Peter">1st Peter</option>'+
		'<option value="2Peter">2nd Peter</option>'+
		'<option value="1John">1st John</option>'+
		'<option value="2John">2nd John</option>'+
		'<option value="3John">3rd John</option>'+
